...
class BlogController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data = [
            ...
            'pendingBlogsToAddTitle'        => $pendingBlogsToAddTitle,
            'pendingBlogsToWrite'           => $pendingBlogsToWrite,
            'pendingBlogsToAddImage'        => $pendingBlogsToAddImage,
            'pendingBlogsToAddToWebsite'    => $pendingBlogsToAddToWebsite,
            'blogsDone'                     => $blogsDone,
    ...
    public function blogList(Request $request)
    {
        ...
        if( $blogType == 'done' ) {
            ...
            $blogs->sort(function ($a, $b) use ($now) {
                abs($now->diffInSeconds(Carbon::parse($a->desired_date)) - $now->diffInSeconds(Carbon::parse($b->desired_date)));
            });
        }
