...
var Task_Details_Widget = {
    ...
    updateProgressCountInTaskRow() {
        $(".TaskRow[data-task-id='" + Task_Details_Widget.task.id + "']").find(".pre-live-check-count").html($("#task-details-wrapper .pre-live-options .pre-post-option:checked").length + "/18");
    },
